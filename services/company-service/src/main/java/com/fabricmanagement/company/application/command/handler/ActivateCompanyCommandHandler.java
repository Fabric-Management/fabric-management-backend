...
import com.fabricmanagement.company.application.command.ActivateCompanyCommand;
...
/**
 * Command Handler for activating a company
 */
@Component
...
public class ActivateCompanyCommandHandler {
    ...
    @Transactional
    public void handle(ActivateCompanyCommand command) {
        log.info("Handling ActivateCompanyCommand for company: {}", command.getCompanyId());
        ...
        log.info("Company activated successfully: {}", command.getCompanyId());
    }
}
