...
|---|---|
| FIBER_MASTERDATA_WRITE | RDPRODUCTDEVELOPMENT, PRODUCTIONPLANNING, FIBERRAWMATERIAL, ADMINISTRATIONOFFICE |
| BATCH_WRITE | R&D, Prod.Planning, Fiber&RawMat., Yarn, Weaving, Dyeing, QC, Warehouse |
| QUALITY_TEST_WRITE | QUALITYCONTROL, RDPRODUCTDEVELOPMENT, FIBERRAWMATERIAL |
| WAREHOUSE_LOCATION_WRITE | WAREHOUSE, PRODUCTIONPLANNING |
| ALL_PRODUCTION_READ | Yukarıdakiler + PROCUREMENTSUPPLY |
