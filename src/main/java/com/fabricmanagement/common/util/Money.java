 ...
 *
 * <p>Immutable, type-safe representation of money that prevents common currency-related bugs and
 * ensures proper decimal precision.
 *
 * <h2>Features:</h2>
 *
 * <ul>
 *   <li>Immutable (thread-safe)
 *   <li>Currency-aware operations
 *   <li>Proper decimal precision (scale = 2)
 *   <li>Type-safe arithmetic operations
 *   <li>Prevents adding different currencies
 * </ul>
 *
 * <h2>Usage Example:</h2>
 *
