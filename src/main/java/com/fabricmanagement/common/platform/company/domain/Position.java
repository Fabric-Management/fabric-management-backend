 ...
 * <ul>
 *   <li>Belongs to a specific department</li>
 *   <li>Can have a default role assignment</li>
 *   <li>Is tenant-isolated (multi-tenant support)</li>
 *   <li>Can be assigned to multiple users (Many-to-Many via UserPosition)</li>
 * </ul>
 *
 * <h2>Relationship:</h2>
 * <ul>
 *   <li>Many Positions belong to One Department (Many-to-One)</li>
 *   <li>One Position can have a default Role (Many-to-One, optional)</li>
 *   <li>Many Users can have Many Positions (Many-to-Many via UserPosition)</li>
 * </ul>
 *
 * <h2>Example:</h2>
 * <pre>{@code
 ...
 * <p>Positions can have a hierarchical parent to establish organizational structure
 * (e.g., "Manager → Supervisor → Operator"). This enables organizational chart visualization
 * and hierarchical reporting.</p>
 *
 * <h2>Position Assignment History:</h2>
 * <p>UserPosition junction tracks assignment dates via effective_date and end_date,
 * enabling job change history and career progression analysis.</p>
 */
@Entity
@Table(name = "common_position", schema = "common_company",
    indexes = {
        ...
        @Index(name = "uk_position_tenant_code", columnList = "tenant_id,position_code", unique = true)
    })
@Getter
@Setter
@Builder
...
public class Position extends BaseEntity {
    ...
    public static Position create(UUID departmentId, String positionName, String positionCode, String description) {
