 ...
 * 
 * <p>Provides endpoints to seed default departments and positions for existing tenants.</p>
 */
@RestController
...
public class TenantSeedController {
     ...
     * 
     * <p><b>Use Case:</b> If a tenant was created before seed was implemented,
     * or if departments/positions were deleted, this endpoint can be used to
     * seed default organizational structure.</p>
     * 
    ...
    public ResponseEntity<ApiResponse<String>> seedDepartmentsAndPositions() {
        ...
        if (tenantSeedService.isTenantSeeded(tenantId, companyId)) {
            ...
            return ResponseEntity.ok(ApiResponse.success("Tenant already has departments. No action taken."));
        }
        ...
        return ResponseEntity.ok(ApiResponse.success(
            "Departments and positions seeded successfully"
        ));
    }
