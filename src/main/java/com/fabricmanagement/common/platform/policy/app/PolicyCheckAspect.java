 ...
 *
 * <p>Intercepts methods annotated with @PolicyCheck and enforces 4-layer access control:
 *
 * <ol>
 *   <li>Layer 1-3: Subscription check (OS → Feature → Quota)
 *   <li>Layer 4: Policy check (RBAC/ABAC)
 * </ol>
 *
 * <h2>Usage:</h2>
 *
...
public class PolicyCheckAspect {
  ...
  public Object checkPolicy(ProceedingJoinPoint joinPoint, PolicyCheck policyCheck)
    ...
    log.debug(
        "[PolicyCheckAspect] Checking access: resource={}, action={}, feature={}",
        resource,
        action,
        featureId);
