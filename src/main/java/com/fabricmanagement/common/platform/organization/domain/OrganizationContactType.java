 ...
 *
 * <p>Unlike {@link com.fabricmanagement.common.platform.communication.domain.ContactType} which
 * describes the <em>channel</em> (EMAIL, MOBILE, …), this enum describes the <em>purpose</em> of
 * the contact relative to the organization (billing, technical support, etc.).
 */
