 ...
 *
 * <ul>
 *   <li>Production - Production-related departments
 *   <li>Administrative - Office / management / support units
 *   <li>Utility - Auxiliary service units
 *   <li>Logistics & Warehouse - Warehouse / shipping / inventory operations
 *   <li>Support & Audit - Training / documentation / audit units
 * </ul>
 *
 * <h2>Relationship:</h2>
 *
 * <p>One DepartmentCategory can have Many Departments (One-to-Many)
 *
 * <h2>Example:</h2>
 *
 * <pre>{@code
...
@Entity
@Table(
    name = "common_department_category",
...
public class DepartmentCategory extends BaseEntity {
  ...
  public static DepartmentCategory create(
      String categoryName, String description, Integer displayOrder) {
