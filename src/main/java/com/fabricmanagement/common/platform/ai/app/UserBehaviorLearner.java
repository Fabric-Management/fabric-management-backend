 ...
 *
 * <p>Simple learning mechanism (no ML): tracks language, common queries, function usage.</p>
 * <p>MANIFESTO: KISS - Simple counters and patterns, no complex ML</p>
 */
@Component
@Slf4j
public class UserBehaviorLearner {
    ...
    public void learn(UUID userId, String query, String functionName, String responseLanguage) {
        ...
        log.debug("Learned from user {}: language={}, function={}, pattern={}", 
            userId, responseLanguage, functionName, pattern);
    }
