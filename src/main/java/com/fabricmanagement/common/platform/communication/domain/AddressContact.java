 ...
 *
 * <p>Represents the relationship between an Address and Contact information. Supports
 * address-specific contacts for both Company and User addresses.
 *
 * <p><b>⚠️ IMPORTANT:</b> This is for <b>address-specific contacts</b> (location-based). For
 * <b>user-level contacts</b> (authentication, notifications), use {@link UserContact}. For
 * <b>company-wide contacts</b> (default, department), use {@link CompanyContact}.
 *
 * <h2>When to Use AddressContact vs Other Contact Types:</h2>
 *
 * <ul>
 *   <li><b>AddressContact:</b> Location-specific contacts (warehouse phone, branch email)
 *   <li><b>UserContact:</b> User's personal/work contacts for authentication
 *   <li><b>CompanyContact:</b> Company-wide default contact, department contacts
 * </ul>
 *
 * <h2>Key Features:</h2>
 *
 * <ul>
 *   <li>✅ Multiple contacts per address (phone, email, fax, etc.)
 *   <li>✅ Primary contact flag (one per address)
 *   <li>✅ Label for categorization
 *   <li>✅ Works for both company and user addresses
 * </ul>
 *
 * <h2>Usage Example:</h2>
 *
...
public class AddressContact extends BaseJunctionEntity {
   ...
   *
   * <p>true = primary contact for this address (one per address)
   */
   ...
   *
   * <p>Examples: "Main Phone", "Reception", "Emergency Contact", "Warehouse Email"
   */
