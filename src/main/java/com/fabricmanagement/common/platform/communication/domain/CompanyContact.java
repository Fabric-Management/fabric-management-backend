 ...
 *
 * <p>Represents the relationship between a Company and their Contact information. Supports multiple
 * contacts per company (main phone, fax, email, website, etc.).
 *
 * <p><b>⚠️ IMPORTANT:</b> This is for <b>company-wide and department-specific contacts</b>. For
 * <b>address-specific contacts</b> (e.g., warehouse phone, branch office email), use {@link
 * AddressContact} instead.
 *
 * <h2>When to Use CompanyContact vs AddressContact:</h2>
 *
 * <ul>
 *   <li><b>CompanyContact:</b> Company-wide default contact, department contacts (Sales, Support)
 *   <li><b>AddressContact:</b> Location-specific contacts tied to a physical address
 * </ul>
 *
 * <h2>Key Features:</h2>
 *
 * <ul>
 *   <li>✅ Multiple contacts per company
 *   <li>✅ Default contact for business communication
 *   <li>✅ Department-specific contacts
 * </ul>
 *
 * <h2>Usage Example:</h2>
 *
...
public class CompanyContact extends BaseJunctionEntity {
   ...
   *
   * <p>true = use this contact as default for company-wide communications
   */
   ...
   *
   * <p>If set, this contact is for a specific department (e.g., "Sales", "Support")
   *
   * <p>null = company-wide contact
   */
