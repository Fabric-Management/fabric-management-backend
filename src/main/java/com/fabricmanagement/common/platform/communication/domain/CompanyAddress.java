 ...
 *
 * <p>Represents the relationship between a Company and their Address information. Supports multiple
 * addresses per company (headquarters, branches, warehouses, etc.).
 *
 * <h2>Key Features:</h2>
 *
 * <ul>
 *   <li>✅ Multiple addresses per company
 *   <li>✅ Primary address flag
 *   <li>✅ Headquarters flag
 * </ul>
 *
 * <h2>Usage Example:</h2>
 *
...
public class CompanyAddress extends BaseJunctionEntity {
   ...
   *
   * <p>true = primary address for this company
   */
   ...
   * Headquarters flag
   *
   * <p>true = this is the company's headquarters
   */
