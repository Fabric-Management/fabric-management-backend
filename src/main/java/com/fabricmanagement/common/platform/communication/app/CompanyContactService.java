 ...
 *
 * <p>Handles Many-to-Many relationship between Company and Contact.
 *
 * <p>Key responsibilities:
 *
 * <ul>
 *   <li>Assign contacts to companies
 *   <li>Remove company-contact assignments
 *   <li>Manage default contact for business communication
 *   <li>Manage department-specific contacts
 * </ul>
 */
@Service
...
public class CompanyContactService {
  ...
  public CompanyContact assignContact(
    ...
    UUID tenantId = TenantContext.getCurrentTenantId();
    log.info(
        "Assigning contact to company: tenantId={}, companyId={}, contactId={}, isDefault={}, department={}",
        tenantId,
        companyId,
        contactId,
        isDefault,
  ...
  public void removeContact(UUID companyId, UUID contactId) {
    UUID tenantId = TenantContext.getCurrentTenantId();
    log.info(
        "Removing contact from company: tenantId={}, companyId={}, contactId={}",
        tenantId,
        companyId,
        contactId);
    ...
    CompanyContact companyContact =
        companyContactRepository
            .findByCompanyIdAndContactId(companyId, contactId)
  ...
  public CompanyContact setAsDefault(UUID companyId, UUID contactId) {
    UUID tenantId = TenantContext.getCurrentTenantId();
    log.info(
        "Setting default contact: tenantId={}, companyId={}, contactId={}",
        tenantId,
        companyId,
        contactId);
