 ...
 * <ul>
 *   <li>✅ Email persistence (survives application crashes)</li>
 *   <li>✅ Transaction safety (email saved in same transaction as business logic)</li>
 *   <li>✅ Retry capability (failed emails can be retried)</li>
 *   <li>✅ Dead letter queue (permanently failed emails are tracked)</li>
 * </ul>
 * 
 * <p><b>Lifecycle:</b>
 * <ol>
 *   <li>PENDING - Email queued, not yet sent</li>
 *   <li>SENDING - Email being sent (background job)</li>
 *   <li>SENT - Email sent successfully</li>
 *   <li>FAILED - Email failed after max retries (dead letter queue)</li>
 * </ol>
 */
@Entity
@Table(name = "communication_email_outbox", schema = "common_communication",
    indexes = {
