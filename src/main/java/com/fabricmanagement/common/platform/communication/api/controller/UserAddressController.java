...
public class UserAddressController {
    ...
    public ResponseEntity<ApiResponse<List<AddressContactDto>>> getAddressContacts(
        ...
        List<AddressContactDto> contacts = userAddressService.getAddressContacts(userId, addressId)
            .stream()
    ...
    public ResponseEntity<ApiResponse<AddressContactDto>> getPrimaryContact(
            @PathVariable UUID userId,
            @PathVariable UUID addressId) {
        log.debug("Getting primary contact for user address: userId={}, addressId={}", userId, addressId);

        AddressContact primaryContact = userAddressService.getPrimaryContact(userId, addressId)
    ...
    public ResponseEntity<ApiResponse<AddressContactDto>> assignContact(
        ...
        log.info("Assigning contact to user address: userId={}, addressId={}, contactId={}, isPrimary={}",
            userId, addressId, request.getContactId(), request.getIsPrimary());
    ...
    public ResponseEntity<ApiResponse<AddressContactDto>> setContactAsPrimary(
        ...
        log.info("Setting primary contact: userId={}, addressId={}, contactId={}", userId, addressId, contactId);
    ...
    public ResponseEntity<ApiResponse<Void>> removeContact(
            ...
            @PathVariable UUID addressId,
            @PathVariable UUID contactId) {
        log.info("Removing contact from user address: userId={}, addressId={}, contactId={}", 
            userId, addressId, contactId);
