 ...
 *
 * <p>Represents the relationship between a User and their Address information. Supports multiple
 * addresses per user (home, work, shipping, etc.).
 *
 * <h2>Key Features:</h2>
 *
 * <ul>
 *   <li>✅ Multiple addresses per user
 *   <li>✅ Primary address flag
 *   <li>✅ Work address flag (independent from company address)
 * </ul>
 *
 * <h2>Usage Example:</h2>
 *
...
public class UserAddress extends BaseJunctionEntity {
   ...
   *
   * <p>true = primary address for this user
   */
   ...
   * Work address flag
   *
   * <p>true = work/office address (independent from company's address)
   *
   * <p>false = personal address (e.g., home)
   */
