 ...
 * 
 * <p>Simple wrapper around {@link EmailTemplateService} for consistent API.
 * Uses backend HTML templates from {@code resources/templates/emails/}.</p>
 * 
 * <p><b>Note:</b> Frontend template rendering was removed. All templates are now
 * rendered directly from backend HTML files.</p>
 */
@Component
