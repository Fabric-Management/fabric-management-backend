 ...
 *
 * <p>Handles Many-to-Many relationship between Company and Address.
 *
 * <p>Key responsibilities:
 *
 * <ul>
 *   <li>Assign addresses to companies
 *   <li>Remove company-address assignments
 *   <li>Manage primary address
 *   <li>Manage headquarters designation
 * </ul>
 */
@Service
...
public class CompanyAddressService {
  ...
  public CompanyAddress assignAddress(
    ...
    UUID tenantId = TenantContext.getCurrentTenantId();
    log.info(
        "Assigning address to company: tenantId={}, companyId={}, addressId={}, isPrimary={}, isHQ={}",
        tenantId,
        companyId,
        addressId,
        isPrimary,
  ...
  public void removeAddress(UUID companyId, UUID addressId) {
    UUID tenantId = TenantContext.getCurrentTenantId();
    log.info(
        "Removing address from company: tenantId={}, companyId={}, addressId={}",
        tenantId,
        companyId,
        addressId);
  ...
  public CompanyAddress setAsPrimary(UUID companyId, UUID addressId) {
    UUID tenantId = TenantContext.getCurrentTenantId();
    log.info(
        "Setting primary address: tenantId={}, companyId={}, addressId={}",
        tenantId,
        companyId,
        addressId);
  ...
  public CompanyAddress setAsHeadquarters(UUID companyId, UUID addressId) {
    UUID tenantId = TenantContext.getCurrentTenantId();
    log.info(
        "Setting headquarters: tenantId={}, companyId={}, addressId={}",
        tenantId,
        companyId,
        addressId);
  ...
  public List<AddressContact> getAddressContacts(UUID companyId, UUID addressId) {
    UUID tenantId = TenantContext.getCurrentTenantId();
    log.debug(
        "Finding contacts for company address: tenantId={}, companyId={}, addressId={}",
        tenantId,
        companyId,
        addressId);
  ...
  public Optional<AddressContact> getPrimaryContact(UUID companyId, UUID addressId) {
    UUID tenantId = TenantContext.getCurrentTenantId();
    log.trace(
        "Finding primary contact for company address: tenantId={}, companyId={}, addressId={}",
        tenantId,
        companyId,
        addressId);
