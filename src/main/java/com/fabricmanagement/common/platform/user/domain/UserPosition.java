 ...
 *
 * <p>Represents the assignment of users to positions. A user can have
 * multiple positions, and each position can be assigned to multiple users.</p>
 *
 * <h2>Features:</h2>
 * <ul>
 *   <li>Many-to-Many relationship between User and Position</li>
 *   <li>Primary position flag (isPrimary) - one position can be marked as primary</li>
 ...
 * <p>Position assignments are tracked with effective_date and end_date fields.
 * This enables:
 * <ul>
 *   <li>Job change history tracking</li>
 *   <li>Historical reporting and analysis</li>
 *   <li>Career progression analysis</li>
 *   <li>Active vs. past assignments (end_date is NULL for active assignments)</li>
 * </ul>
 */
@Entity
@Table(name = "common_user_position", schema = "common_user",
    indexes = {
...
public class UserPosition {
    ...
    public static UserPosition create(User user, Position position, boolean isPrimary, UUID assignedBy) {
