 ...
 * 
 * <p>Allows users to request profile changes that require HR/Admin approval.</p>
 * 
 * <h2>Workflow:</h2>
 * <ol>
 *   <li>User submits request → Status: PENDING</li>
 *   <li>HR/Admin reviews and approves/rejects → Status: APPROVED/REJECTED</li>
 *   <li>If approved, profile is updated and user is notified</li>
 * </ol>
 * 
 * <h2>Multi-Tenancy:</h2>
 * <p>Inherits tenant_id from BaseEntity. All queries MUST be tenant-scoped.</p>
 */
@Entity
@Table(name = "profile_update_request", schema = "common_user",
    indexes = {
...
public class ProfileUpdateRequest extends BaseEntity {
     ...
     * Example: {"firstName": "John", "lastName": "Smith", "personalPhone": "+1234567890"}
     */
