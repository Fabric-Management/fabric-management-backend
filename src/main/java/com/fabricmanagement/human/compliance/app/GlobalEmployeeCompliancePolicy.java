...
public class GlobalEmployeeCompliancePolicy implements EmployeeCompliancePolicy {
    ...
    private static final List<String> RECOMMENDED_FIELDS = List.of("employeeNumber", "hireDate", "department", "emergencyContact");
    ...
    public boolean supports(String countryCode) {
        ...
        return HrLocalizationConstants.GLOBAL_COUNTRY_CODE.equals(normalized) || "DEFAULT".equals(normalized);
    }
    ...
    public List<String> evaluate(Employee employee, EmployeeComplianceContext context) {
        ...
        boolean departmentMissing = context.departmentValue()
            .map(String::isBlank)
            .orElse(true);
        ...
        return missing.stream()
            .filter(RECOMMENDED_FIELDS::contains)
            .distinct()
            .toList();
    }
