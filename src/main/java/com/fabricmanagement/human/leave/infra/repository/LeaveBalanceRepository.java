...
public interface LeaveBalanceRepository extends JpaRepository<LeaveBalance, UUID> {
    ...
    @Query("""
        ...
        """)
    Optional<LeaveBalance> findByEmployeeAndType(@Param("tenantId") UUID tenantId,
    ...
    @Query("""
        ...
        where lb.tenantId = :tenantId
          and lb.employeeId = :employeeId
        """)
    List<LeaveBalance> findByEmployee(@Param("tenantId") UUID tenantId, @Param("employeeId") UUID employeeId);
}
