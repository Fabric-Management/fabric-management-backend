...
public class LeaveBalanceService {
    ...
    public LeaveBalance getOrCreateBalance(UUID tenantId, UUID employeeId, LeaveType leaveType, String countryCode) {
        return leaveBalanceRepository.findByEmployeeAndType(tenantId, employeeId, leaveType)
            .orElseGet(() -> {
