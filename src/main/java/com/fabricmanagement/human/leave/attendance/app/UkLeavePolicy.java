...
public class UkLeavePolicy extends EuLeavePolicy {
  ...
  public LeaveAccrualResult calculateAccrual(LeavePolicyRequest request) {
    ...
    boolean bankHolidaysIncluded =
        getBoolean(attributes, "leave.annual.bankHolidaysIncluded", true);
  ...
  private boolean getBoolean(
      java.util.Map<String, Object> attributes, String path, boolean defaultValue) {
