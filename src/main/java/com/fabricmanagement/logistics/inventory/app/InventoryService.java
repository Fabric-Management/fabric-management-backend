 ...
 *
 * <p>Implements InventoryFacade for cross-module communication.
 *
 * <p>Note: Stock quantity and location currently return placeholder values. Real repository
 * integration pending.
 */
@Service
...
public class InventoryService implements InventoryFacade {
  ...
  public Optional<StockInfo> getStockByMaterialName(UUID tenantId, String materialName) {
    ...
    log.debug(
        "Stock info retrieved: material={}, quantity={}",
        materialDto.getUid(),
        stockInfo.quantity());
