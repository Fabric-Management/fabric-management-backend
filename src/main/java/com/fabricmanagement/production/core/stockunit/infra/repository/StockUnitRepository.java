...
public interface StockUnitRepository extends JpaRepository<StockUnit, UUID> {
  ...
  int applyQualityDisposition(
      ...
      @Param("statuses") Collection<StockUnitStatus> statuses,
      @Param("disposition")
          com.fabricmanagement.production.core.stockunit.domain.QualityDisposition disposition);
  ...
  @Query(
      ...
      WHERE s.tenantId = :tenantId
        AND s.batchId IN :batchIds
        AND s.isActive = true
        AND s.qualityDisposition = com.fabricmanagement.production.core.stockunit.domain.QualityDisposition.RELEASED
  ...
  interface AvailabilityPieceBreakdownRow {
    ...
    com.fabricmanagement.production.core.stockunit.domain.PackageType getPackageType();
  ...
  interface QualityDispositionCount {
    com.fabricmanagement.production.core.stockunit.domain.QualityDisposition getDisposition();
