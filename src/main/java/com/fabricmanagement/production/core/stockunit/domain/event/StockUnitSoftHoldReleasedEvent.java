package com.fabricmanagement.production.core.stockunit.domain.event;
...
@Getter
public class StockUnitSoftHoldReleasedEvent extends DomainEvent {
  ...
  public StockUnitSoftHoldReleasedEvent(
    ...
    super(tenantId, "STOCK_UNIT_SOFT_HOLD_RELEASED");
    this.quoteLineId = quoteLineId;
    this.stockUnitId = stockUnitId;
    this.softHoldId = softHoldId;
  }
