package com.fabricmanagement.production.core.lineage.domain.rule;
 ...
 * source→target product type pair (e.g. FIBER→YARN).
 *
 ...
 * com.fabricmanagement.production.core.lineage.domain.port.BatchAttributeInheritancePort#resolveInheritedAttributes}.
 ...
 * </pre>
 *
 * @param sourceType product type of the consumed parent batch(es) (e.g. FIBER)
 * @param targetType product type of the batch being produced (e.g. YARN)
...
public record AttributeInheritanceSchema(
    ProductType sourceType, ProductType targetType, List<InheritanceRule> rules) {}
