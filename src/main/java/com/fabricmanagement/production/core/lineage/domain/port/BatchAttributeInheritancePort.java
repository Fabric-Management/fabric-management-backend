package com.fabricmanagement.production.core.lineage.domain.port;
 ...
 *
 * @see com.fabricmanagement.production.core.lineage.domain.BatchLineage
 * @see com.fabricmanagement.production.core.lineage.domain.rule.BatchAttributes
