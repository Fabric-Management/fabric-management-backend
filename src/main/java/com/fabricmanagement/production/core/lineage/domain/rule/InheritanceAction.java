 ...
 *
 * <p>Used by {@link
 * com.fabricmanagement.production.core.lineage.domain.rule.AttributeInheritanceSchema} to describe
 * per-attribute rules for a given source→target product type pair (e.g. FIBER→YARN).
 */
