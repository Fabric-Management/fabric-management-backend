package com.fabricmanagement.production.core.goodsreceipt.domain;
...
public class GoodsReceipt extends BaseEntity {
   ...
   *
   * @throws
   *     com.fabricmanagement.production.core.goodsreceipt.domain.exception.GoodsReceiptDomainException
   *     if not in DRAFT
   */
  public void assertIsDraft() {
    if (this.status != GoodsReceiptStatus.DRAFT) {
      throw new com.fabricmanagement.production.core.goodsreceipt.domain.exception
