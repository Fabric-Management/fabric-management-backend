package com.fabricmanagement.production.core.goodsreceipt.app;
...
import com.fabricmanagement.production.core.batch.api.query.BatchQueryService;
...
import com.fabricmanagement.production.core.goodsreceipt.domain.GoodsReceipt;
import com.fabricmanagement.production.core.goodsreceipt.domain.GoodsReceiptItem;
import com.fabricmanagement.production.core.goodsreceipt.domain.GoodsReceiptStatus;
import com.fabricmanagement.production.core.goodsreceipt.domain.event.GoodsReceiptConfirmedEvent;
import com.fabricmanagement.production.core.goodsreceipt.domain.exception.GoodsReceiptDomainException;
import com.fabricmanagement.production.core.goodsreceipt.domain.port.PoReceivabilityPort;
import com.fabricmanagement.production.core.goodsreceipt.dto.CreateGoodsReceiptRequest;
import com.fabricmanagement.production.core.goodsreceipt.dto.GoodsReceiptResponse;
import com.fabricmanagement.production.core.goodsreceipt.infra.repository.GoodsReceiptItemRepository;
import com.fabricmanagement.production.core.goodsreceipt.infra.repository.GoodsReceiptRepository;
...
public class GoodsReceiptService {
  ...
  private String getSourceIdentifier(
      com.fabricmanagement.production.core.goodsreceipt.domain.GoodsReceiptSourceType sourceType,
      UUID sourceId) {
  ...
  private ProductType resolvePurchaseProductType(
      ...
      UUID sourceLineId) {
    if (sourceType
        != com.fabricmanagement.production.core.goodsreceipt.domain.GoodsReceiptSourceType
            .PURCHASE_ORDER) {
      return null;
    }
