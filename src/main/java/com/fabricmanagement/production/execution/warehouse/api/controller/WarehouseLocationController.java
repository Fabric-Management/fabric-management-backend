package com.fabricmanagement.production.execution.warehouse.api.controller;
...
import com.fabricmanagement.production.execution.warehouse.domain.StorageCondition;
import com.fabricmanagement.production.execution.warehouse.domain.WarehouseLocationType;
import com.fabricmanagement.production.execution.warehouse.dto.ChangeLocationStatusRequest;
import com.fabricmanagement.production.execution.warehouse.dto.CreateWarehouseLocationRequest;
import com.fabricmanagement.production.execution.warehouse.dto.UpdateWarehouseLocationRequest;
import com.fabricmanagement.production.execution.warehouse.dto.WarehouseLocationDto;
import com.fabricmanagement.production.execution.warehouse.dto.WarehouseLocationTreeDto;
...
@RestController
@RequestMapping("/api/production/warehouse-locations")
...
public class WarehouseLocationController {
  ...
  @PostMapping
  @PreAuthorize(
      "@productionAccessService.hasPermission(authentication, 'WAREHOUSE_LOCATION', 'WRITE')")
  ...
  @GetMapping
  @PreAuthorize(
      "@productionAccessService.hasPermission(authentication, 'WAREHOUSE_LOCATION', 'READ')")
