 ...
 *
 * <p>A fiber can have multiple certifications (GOTS, OEKO_TEX, FAIRTRADE, etc.).
 *
 * <p>This represents the many-to-many relationship between Fiber and FiberCertification.
 *
 * <p>Includes certification validity period and certificate number.
 *
 * <h2>Example:</h2>
 *
 * <pre>{@code
...
@Entity
@Table(
    name = "prod_fiber_certification_link",
    schema = "production",
    indexes = {
...
public class FiberCertificationLink extends BaseJunctionEntity {
   ...
   *
   * <p>Unique identifier provided by the certifying body.
   */
   ...
   *
   * <p>When the certification became effective.
   */
   ...
   *
   * <p>When the certification expires (null = no expiry).
   */
