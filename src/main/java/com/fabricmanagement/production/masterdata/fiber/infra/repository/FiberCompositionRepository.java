...
import com.fabricmanagement.production.masterdata.fiber.domain.FiberCompositionId;
...
@Repository
public interface FiberCompositionRepository extends JpaRepository<FiberComposition, FiberCompositionId> {
