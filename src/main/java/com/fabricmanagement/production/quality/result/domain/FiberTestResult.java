 ...
 *
 * <p><b>Purpose:</b> Stores actual measurement values from laboratory tests or production quality checks.</p>
 * <p>Each test result belongs to a specific FiberBatch and records the physical properties measured.</p>
 *
 * <p><b>Domain Separation:</b></p>
 * <ul>
 *   <li>Fiber = Catalog definition (what type of fiber)</li>
 *   <li>FiberBatch = Production lot (physical inventory)</li>
 *   <li>FiberTestResult = Laboratory measurements (test data)</li>
 * </ul>
 */
@Entity
@Table(name = "production_quality_fiber_test_result", schema = "production",
    indexes = {
