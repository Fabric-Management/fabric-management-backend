 ...
 *
 * <p>Sends verification codes via WhatsApp Business API.
 *
 * <p><b>Priority:</b> Highest (1) - Fastest delivery, highest open rate.
 *
 * <p><b>Requirements:</b>
 *
 * <ul>
 *   <li>WhatsApp Business API account configured
 *   <li>Verification template approved in Meta Business
 *   <li>Phone number must have WhatsApp capability
 * </ul>
 */
@Component
...
public class WhatsAppStrategy implements VerificationStrategy {
  ...
  public void sendVerificationCode(String recipient, String code) {
    log.info("Sending WhatsApp verification code to: {}", PiiMaskingUtil.maskPhone(recipient));
