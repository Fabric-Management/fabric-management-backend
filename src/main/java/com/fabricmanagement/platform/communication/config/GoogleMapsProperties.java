package com.fabricmanagement.platform.communication.config;
 ...
 *
 * <p>Externalizes all Google Maps API configuration from application.yml and environment variables.
 *
 * <p><b>Usage:</b>
 *
 * <pre>{@code
