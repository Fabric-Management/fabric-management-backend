 ...
 * Not used in autocomplete - Google's smart relevance handles country detection automatically.
 *
 * <p>Improves Google Geocoding API accuracy by using components parameter instead of country name
 * in address query.
 */
@UtilityClass
