...
import com.fabricmanagement.platform.user.domain.event.AddressAssignedEvent;
import com.fabricmanagement.platform.user.infra.repository.UserAddressRepository;
