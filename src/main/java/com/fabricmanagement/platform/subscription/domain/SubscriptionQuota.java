package com.fabricmanagement.platform.subscription.domain;
 ...
 *
 * <p>Tracks usage limits for various resources (users, API calls, storage, etc.) per subscription.
 * This is Layer 3 of the Policy Engine.
 *
 * <h2>Quota Types:</h2>
 *
 * <ul>
 *   <li><strong>users</strong> - Number of active users
 *   <li><strong>api_calls</strong> - API requests per month
 *   <li><strong>storage_gb</strong> - Storage space in GB
 *   <li><strong>fiber_entities</strong> - Number of fiber entities (YarnOS)
 *   <li><strong>yarn_skus</strong> - Number of yarn SKUs (YarnOS)
 *   <li><strong>iot_devices</strong> - Number of IoT devices (EdgeOS)
 *   <li><strong>integrations</strong> - Number of active integrations (CustomOS)
 * </ul>
 *
 * <h2>Reset Periods:</h2>
 *
 * <ul>
 *   <li><strong>NONE</strong> - Static limit, never resets (e.g., users, storage)
 *   <li><strong>MONTHLY</strong> - Resets on 1st of each month (e.g., API calls)
 *   <li><strong>DAILY</strong> - Resets daily (rare, for rate limiting)
 * </ul>
 *
 * <h2>Example:</h2>
 *
...
@Entity
@Table(
    name = "common_subscription_quota",
    ...
    uniqueConstraints = {
      @UniqueConstraint(
          name = "uk_tenant_subscription_quota",
...
public class SubscriptionQuota extends BaseEntity {
   ...
   *
   * <p>Examples: "users", "api_calls", "storage_gb", "fiber_entities"
   */
   ...
   *
   * <p>Use {@code Long.MAX_VALUE} for "unlimited" quotas.
   */
   ...
   *
   * <p>Incremented as resources are consumed, reset based on {@link #resetPeriod}.
   */
   ...
   *
   * <p>Only applicable for MONTHLY/DAILY quotas.
   */
   ...
   *
   * <p>Updates {@link #lastResetAt} to current time.
   */
  public void reset() {
    this.quotaUsed = 0L;
