 ...
 *
 * <p>Each OS has its own valid tier names. This utility class provides validation and default tier
 * selection based on the OS.
 *
 * <h2>Tier Naming by OS:</h2>
 *
 * <ul>
 *   <li><strong>YarnOS, LoomOS, KnitOS, DyeOS, EdgeOS:</strong> Starter, Professional, Enterprise
 *   <li><strong>AnalyticsOS:</strong> Standard, Advanced, Enterprise
 *   <li><strong>AccountOS, CustomOS:</strong> Standard, Professional, Enterprise
 *   <li><strong>IntelligenceOS:</strong> Professional, Enterprise (no starter tier)
 *   <li><strong>FabricOS:</strong> Base (single tier, included for all)
 * </ul>
 *
 * <h2>Example Usage:</h2>
 *
...
public class PricingTierValidator {
  ...
  private static final Map<String, Set<String>> OS_VALID_TIERS =
      Map.of(
   ...
   *
   * <p>Useful for comparing tiers or checking if upgrade is required.
   *
   ...
   *
   * <p>Example: "Enterprise" meets minimum of "Professional" → true
   *
