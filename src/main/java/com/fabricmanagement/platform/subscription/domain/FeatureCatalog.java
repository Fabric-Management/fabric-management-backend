 ...
 *
 * <p>Defines which features exist in the system, which OS they belong to, and which pricing tiers
 * include them. This is used for:
 *
 * <ul>
 *   <li>Feature entitlement checks (Layer 2 of Policy Engine)
 *   <li>Admin UI for subscription management
 *   <li>Customer-facing pricing pages
 *   <li>Feature discovery and documentation
 * </ul>
 *
...
public class FeatureCatalog extends BaseEntity {
   ...
   *
   * <p>Format: {os_prefix}.{module}.{feature_name}
   *
   * <p>Example: "yarn.blend.management"
   */
   ...
   *
   * <p>Examples: "YarnOS", "LoomOS", "FabricOS"
   */
   ...
   *
   * <p>Used in admin UI and customer-facing documentation.
   */
   ...
   *
   * <p>Array of tier names: ["PROFESSIONAL", "ENTERPRISE"]
   *
   * <p>Empty array means feature is available in all tiers.
   */
  @Type(JsonType.class)
   ...
   *
   * <p>Examples: "Production", "Analytics", "Integration", "Core"
   */
   ...
   *
   * <p>Can be used to soft-deprecate features or enable beta features.
   */
   ...
   *
   * <p>Example: "yarn.iot.sensors" requires EdgeOS to be active
   */
   ...
   *
   * <p>Returns the "lowest" tier name from availableInTiers. For YarnOS/LoomOS/etc: Starter <
   * Professional < Enterprise For AnalyticsOS/AccountOS: Standard < Advanced/Professional <
   * Enterprise
   *
  ...
  private void validate() {
    ...
    String[] parts = featureId.split("\\.");
    if (parts.length < 2) {
      throw new IllegalStateException("Feature ID must follow format: {os}.{module}.{feature}");
    }
