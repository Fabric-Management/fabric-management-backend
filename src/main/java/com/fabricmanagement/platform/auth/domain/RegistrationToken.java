 ...
 *
 * <ul>
 *   <li><b>Sales-led onboarding:</b> Token-only (email verified by click)
 *   <li><b>Self-service signup:</b> Token + verification code (double security)
 * </ul>
 *
 * <h2>Security:</h2>
 *
 * <ul>
 *   <li>Token is UUID - globally unique, unguessable
 *   <li>24-hour expiry for security
 *   <li>Single-use only
 *   <li>Linked to specific contact value
 * </ul>
 *
 * <h2>Usage:</h2>
 *
