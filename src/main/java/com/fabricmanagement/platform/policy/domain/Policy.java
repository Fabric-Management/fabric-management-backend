 ...
 *
 * <p>Defines who can do what under which conditions. This is Layer 4 of the 4-Layer Access Control
 * Architecture.
 *
...
public class Policy extends BaseEntity {
  ...
  public static Policy createAllowPolicy(
      String policyId, String resource, String action, Map<String, Object> conditions) {
  ...
  public static Policy createDenyPolicy(
      String policyId, String resource, String action, Map<String, Object> conditions) {
    return Policy.builder()
        .policyId(policyId)
        .resource(resource)
