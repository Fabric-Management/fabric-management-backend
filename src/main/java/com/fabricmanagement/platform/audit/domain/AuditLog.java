 ...
 *
 * <p>Records ALL critical operations for compliance and security.
 *
 * <h2>What to Audit:</h2>
 *
 * <ul>
 *   <li>User actions (CREATE, UPDATE, DELETE)
 *   <li>Authentication events (LOGIN, LOGOUT, FAILED_LOGIN)
 *   <li>Policy decisions (ALLOW, DENY)
 *   <li>Data changes (before/after values)
 *   <li>Security events (SUSPICIOUS_ACCESS)
...
public class AuditLog extends BaseEntity {
  ...
  public static AuditLog createSecurityEvent(
      UUID userId, String action, String description, String ipAddress, AuditSeverity severity) {
    return AuditLog.builder()
        .userId(userId)
        .action(action)
        .resource("security")
