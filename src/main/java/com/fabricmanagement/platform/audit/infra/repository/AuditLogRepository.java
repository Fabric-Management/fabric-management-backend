package com.fabricmanagement.platform.audit.infra.repository;
...
public interface AuditLogRepository extends JpaRepository<AuditLog, UUID> {
  ...
  Page<AuditLog> findByTenantIdAndResourceOrderByTimestampDesc(
  ...
  @Query(
      "SELECT a FROM AuditLog a WHERE a.tenantId = :tenantId AND a.timestamp BETWEEN :start AND :end ORDER BY a.timestamp DESC")
