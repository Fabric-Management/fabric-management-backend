...
public class QualityGradeService {
   ...
   *
   * @throws NotFoundException if not found or if the grade belongs to a different tenant
   */
  @Transactional(readOnly = true)
  public QualityGrade findById(UUID gradeId) {
    ...
    return qualityGradeRepository
        ...
        .orElseThrow(() -> new NotFoundException("QualityGrade not found: " + gradeId));
  }
  ...
  public QualityGrade create(
    ...
    if (qualityGradeRepository.existsByTenantIdAndProductTypeAndCode(
      ...
      throw new QualityGradeDomainException(
