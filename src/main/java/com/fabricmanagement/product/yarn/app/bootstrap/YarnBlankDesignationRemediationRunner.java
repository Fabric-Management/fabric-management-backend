...
@Slf4j
public class YarnBlankDesignationRemediationRunner {

  private final YarnBlankDesignationRemediationService remediationService;
      ...
      long remediated =
          TenantContext.executeInTenantContext(
              ...
              () -> {
                ...
                return remediationService.remediateTenant(tenant.getKey());
              });
      log.info(
          "Yarn blank source-designation remediation completed: tenantId={}, rows={}",
          tenant.getKey(),
          remediated);
    }
  }
