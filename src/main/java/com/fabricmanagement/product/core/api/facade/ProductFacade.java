...
public interface ProductFacade {
   ...
   */
  List<com.fabricmanagement.product.core.dto.ProductAttributeDto> getAttributes(String scope);
   ...
   */
  com.fabricmanagement.product.core.dto.ProductAttributeDto ensureAttribute(
